...
?>
	...
	<input class="rad-caroussel" type="radio" name="rad-caroussel">
		...
		<h2><?php echo $tPropriété['typeCours'] ?></h2>
					<section <?php echo (in_array($tPropriété['typeCours'], ['Web', 'Jeu', 'Spécifique']) ? 'class="caroussel-2"':'class="bloc"'); ?>>
		<?php endif ?>

			<?php if (in_array($tPropriété['typeCours'], ['Web', 'Jeu', 'Spécifique']) ) : 
						get_template_part( 'template-parts/content', 'cours-caroussel' ); 
						$chaine_bouton_radio .= '<input class="rad-caroussel"  type="radio" name="rad-'.$tPropriété['typeCours'].'">';
				else :		
